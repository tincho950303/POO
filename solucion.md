...
📂 ConsoleSolution/
├── 📂 src/
│ └── 📂 ConsoleApp/ ← tu aplicación de consola
├── 📂 tests/ ← (opcional) pruebas unitarias
└──
📄 ConsoleSolution.sln ← archivo de solución
...
tree /F # Windows
# o
ls -R # Linux/macOS🚀 Paso 3: Compilar y ejecutar
...
cd ../..
dotnet new classlib --name ConsoleLibrary --output src/ConsoleLibrary --frameworknet10.0
...
true -p:PublishSingleFile=true -o ./publish
# El ejecutable estará en la carpeta ./publish🧪 Paso 8: Agregar pruebas unitarias
